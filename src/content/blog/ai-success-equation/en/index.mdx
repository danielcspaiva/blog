...
<p className="text-center text-sm italic">Illustration generated by GPT-5</p>
...
<p className="text-center text-sm italic">Diagram from <a href="https://www.youtube.com/watch?v=ysPbXH0LpIE">Advanced Prompt Engineering</a> by Anthropic</p>
