...
import promptEngineering from "../media/prompt-engineering.png";
...
> <p class="text-xl font-semibold rounded-lg p-2">
>   p = <span class="term-knowledge">K</span> × <span class="term-context">C</span> ×{" "}
>   <span class="term-tools">T</span>
> </p>
...
> <p class="text-xl font-semibold rounded-lg p-2">
>   p = <span class="term-knowledge">K</span>
>   <sup>
>     <span class="term-knowledge-weight">α</span>
>   </sup>{" "}
>   × <span class="term-context">C</span>
>   <sup>
>     <span class="term-context-weight">β</span>
>   </sup>{" "}
>   × <span class="term-tools">T</span>
>   <sup>
>     <span class="term-tools-weight">γ</span>
>   </sup>
> </p>
...
<details class="animate group rounded-lg border border-black/15 dark:border-white/20 mb-6">
    ...
    For example, if <span class="term-context-weight">β</span> = <span class="term-context-weight">0.8</span> and <span class="term-knowledge-weight">α</span> = <span class="term-knowledge-weight">0.1</span>, then <span class="term-context">context</span> dominates: even with perfect <span class="term-knowledge">knowledge</span> (<span class="term-knowledge">K</span>=<span class="term-knowledge">1.0</span>), poor <span class="term-context">context</span> (<span class="term-context">C</span>=<span class="term-context">0.2</span>) would give:
    ...
    But with good <span class="term-context">context</span> (<span class="term-context">C</span>=<span class="term-context">0.9</span>), you get:
    ...
    - **<span class="term-knowledge-weight">α</span> (<span class="term-knowledge">knowledge</span> exponent):** Higher for specialized domains (e.g. surgery <span class="term-knowledge-weight">α</span>≈<span class="term-knowledge-weight">0.6</span>), lower for routine tasks (data entry <span class="term-knowledge-weight">α</span>≈<span class="term-knowledge-weight">0.2</span>).
    - **<span class="term-context-weight">β</span> (<span class="term-context">context</span> exponent):** Extremely high for debugging (<span class="term-context-weight">β</span>≈<span class="term-context-weight">0.7</span>), moderate for creative tasks (<span class="term-context-weight">β</span>≈<span class="term-context-weight">0.4</span>).
    - **<span class="term-tools-weight">γ</span> (<span class="term-tools">tools</span> exponent):** Strong in technical work (<span class="term-tools-weight">γ</span>≈<span class="term-tools-weight">0.5</span>), lower in pure reasoning (<span class="term-tools-weight">γ</span>≈<span class="term-tools-weight">0.2</span>).
    </div>
...
**The result:** Humans usually struggle with _knowledge_, which is why education takes years. AIs struggle with _context_, which is why prompt (or context) engineering exists.
      ...
      getWeather: {
        ...
        execute: async ({ city, unit }) => {
          const res = await fetch(
            `https://example.com/api/weather?city=${encodeURIComponent(city)}&unit=${unit}`,
          );
...
<Callout type="error">Vercel deploy failed. Help!</Callout>
...
<Image
  alt="Two young fish swimming along meet an older fish who asks 'Morning, boys. How's the water?' The young fish continue swimming, with one eventually asking 'What the hell is water?'"
  src={water}
/>
...
<blockquote class="twitter-tweet" data-theme="light">
  <p lang="en" dir="ltr">
    ...
    <br />
    <br />
    Some engineers really can&#39;t seem to grasp that LLMs are non-deterministic and how to build
    software taking that into account.
    <br />
    <br />
    For others it immediately clicked, but for some it seems like there&#39;s a real mental barrier
    to accept it.
  </p>
  &mdash; Thorsten Ball (@thorstenball){" "}
  <a href="https://twitter.com/thorstenball/status/1956017792484040731?ref_src=twsrc%5Etfw">
    August 14, 2025
  </a>
</blockquote>
...
<blockquote class="twitter-tweet" data-theme="light">
  <p lang="en" dir="ltr">
    I really like the term "context engineering" over prompt engineering. <br />
    <br />
    It describes the core skill better: the art of providing all the context for the task to be
    plausibly solvable by the LLM.
  </p>
  &mdash; tobi lutke (@tobi){" "}
  <a href="https://twitter.com/tobi/status/1935533422589399127?ref_src=twsrc%5Etfw">
    June 19, 2025
  </a>
</blockquote>
...
<Image
  alt="Prompt structure diagram showing the 10 essential components for effective AI communication"
  src={promptEngineering}
/>
<p class="text-center text-sm italic">
  Diagram from <a href="https://www.youtube.com/watch?v=ysPbXH0LpIE">Advanced Prompt Engineering</a>{" "}
  by Anthropic
</p>
...
<blockquote class="twitter-tweet" data-theme="light">
  <p lang="en" dir="ltr">
    Imagine success being determined purely based on the quality of your thoughts. That's the
    promise of AI
  </p>
  &mdash; Guillermo Rauch (@rauchg){" "}
  <a href="https://twitter.com/rauchg/status/1956356467898114443?ref_src=twsrc%5Etfw">
    August 15, 2025
  </a>
</blockquote>
...
Next time you give a task to an AI (or a teammate), ask yourself: Does it have enough <span class="term-knowledge">knowledge</span>? Did I give it enough <span class="term-context">context</span>? Does it have access to the right <span class="term-tools">tools</span>?
