...
Some people claim that AI means the end of all jobs and even the downfall of humankind. Others dismiss it as hype and vaporware. I stand somewhere else: I believe this technology is real, here to stay, and transformative — but only if we understand what actually drives success with these systems.
...
It’s not about being “good with computers” or having access to the latest models. Something more fundamental is at play.

After countless hours experimenting with models, building AI agents, coding with AI editors and CLIs, and studying how others succeed, I arrived at a straightforward equation that captures the probability of success. This article is my attempt to share that framework.
