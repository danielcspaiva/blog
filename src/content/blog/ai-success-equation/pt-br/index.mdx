...
<p className="text-center text-sm italic">Ilustração gerada por GPT-5</p>
...
<p className="text-center text-sm italic">Diagrama de <a href="https://www.youtube.com/watch?v=ysPbXH0LpIE">Advanced Prompt Engineering</a> da Anthropic</p>
