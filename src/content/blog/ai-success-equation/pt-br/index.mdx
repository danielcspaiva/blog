...
**O resultado:** Humanos geralmente têm dificuldade com _conhecimento_, é por isso que educação leva anos. IAs sofrem com _contexto_, é por isso que engenharia de prompt (ou contexto) existe.
...
<Callout type="error">Deploy do Vercel falhou. Ajuda!</Callout>
...
<Image
  alt="Dois peixes jovens nadando encontram um peixe mais velho que pergunta 'Bom dia, rapazes. Como está a água?' Os peixes jovens continuam nadando, com um eventualmente perguntando 'Que diabos é água?'"
  src={water}
/>
...
<Image
  alt="Diagrama de estrutura de prompt mostrando os 10 componentes essenciais para comunicação eficaz com IA"
  src={promptEngineering}
/>
<p class="text-center text-sm italic">
  Diagrama de <a href="https://www.youtube.com/watch?v=ysPbXH0LpIE">Advanced Prompt Engineering</a>{" "}
  da Anthropic
</p>
