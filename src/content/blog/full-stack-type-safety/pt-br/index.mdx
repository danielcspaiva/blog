...
description: Como é a experiência de ter segurança de tipos full-stack e por que ela é inegociável
date: 2025-04-14
...
Enquanto [tRPC](https://trpc.io/) com [Prisma](https://www.prisma.io/) ou [Drizzle](https://orm.drizzle.team/) oferecem soluções elegantes, existem alternativas:
...
O tRPC oferece vantagens através de:
