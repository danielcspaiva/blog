...
import fullStackTypeSafety from "../fullstack-type-safety.png";
      ...
      {posts && posts.length > 0 ? (
        posts.map((post, index) =>
          post && post.title && post.content ? (
            ...
            <div key={index}>
              <p>Formato de post inesperado</p>
            </div>
          ),
        )
      ) : (
...
<Image alt="End-to-End Type Safety" src={fullStackTypeSafety} />
...
<video
  src="/blog/full-stack-type-safety/v10-dark-landscape.mp4"
  autoPlay
  loop
  muted
  playsInline
...
<small className="text-gray-500 block text-center mb-4">
  Crédito do vídeo: [tRPC website](https://trpc.io/)
</small>
