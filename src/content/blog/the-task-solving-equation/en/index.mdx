...
The exponents are used to adjust the importance of each factor for each type of task, with <span class="term-knowledge-weight">α</span>, <span class="term-context-weight">β</span>, <span class="term-tools-weight">γ</span> ≥ 0 and <span class="term-knowledge-weight">α</span> + <span class="term-context-weight">β</span> + <span class="term-tools-weight">γ</span> = 1.

<details>
<summary>Understanding the exponents</summary>
...
For example, if <span class="term-context-weight">β</span> = 0.8 and <span class="term-knowledge-weight">α</span> = 0.1, then <span class="term-context">context</span> dominates: even with perfect <span class="term-knowledge">knowledge</span> (K=1.0), poor <span class="term-context">context</span> (C=0.2) would give p = 1.0^0.1 × 0.2^0.8 × T^0.1 ≈ 0.26 × T^0.1. But with good <span class="term-context">context</span> (C=0.9), you get p = 1.0^0.1 × 0.9^0.8 × T^0.1 ≈ 0.87 × T^0.1.
...
**Good context more than tripled the odds of success—from 15% to 53%.** The same expert, same tools, but clear context transforms a likely failure into a reasonable chance of success. (See mathematical breakdown below.)
...
- **<span class="term-knowledge-weight">α</span>** = 0.2 (<span class="term-knowledge">knowledge</span> exponent): Moderate contribution from domain knowledge
- **<span class="term-context-weight">β</span>** = 0.6 (<span class="term-context">context</span> exponent): Very high, debugging is nearly impossible without specifics
- **<span class="term-tools-weight">γ</span>** = 0.2 (<span class="term-tools">tools</span> exponent): Moderate, debugging benefits from logs, version control, etc.
...
<p class="text-xl font-semibold rounded-lg p-2">p = <span class="term-knowledge">0.8</span><sup><span class="term-knowledge-weight">0.2</span></sup> × <span class="term-context">0.2</span><sup><span class="term-context-weight">0.6</span></sup> × <span class="term-tools">0.9</span><sup><span class="term-tools-weight">0.2</span></sup> ≈ 0.15 or 15%</p>
...
<p class="text-xl font-semibold rounded-lg p-2">p = <span class="term-knowledge">0.8</span><sup><span class="term-knowledge-weight">0.2</span></sup> × <span class="term-context">0.9</span><sup><span class="term-context-weight">0.6</span></sup> × <span class="term-tools">0.9</span><sup><span class="term-tools-weight">0.2</span></sup> ≈ 0.53 or 53%</p>
