...
Por exemplo, se <span class="term-context-weight">β</span> = 0.8 e <span class="term-knowledge-weight">α</span> = 0.1, então o <span class="term-context">contexto</span> domina: mesmo com <span class="term-knowledge">conhecimento</span> perfeito (K=1.0), <span class="term-context">contexto</span> ruim (C=0.2) daria p = 1.0^0.1 × 0.2^0.8 × T^0.1 ≈ 0.28 × T^0.1. Mas com bom <span class="term-context">contexto</span> (C=0.9), você obtém p = 1.0^0.1 × 0.9^0.8 × T^0.1 ≈ 0.92 × T^0.1.
...
<p class="text-xl font-semibold rounded-lg p-2">p = <span class="term-knowledge">0.8</span><sup><span class="term-knowledge-weight">0.2</span></sup> × <span class="term-context">0.2</span><sup><span class="term-context-weight">0.6</span></sup> × <span class="term-tools">0.9</span><sup><span class="term-tools-weight">0.2</span></sup> ≈ 0.36 ou 36%</p>
...
<p class="text-xl font-semibold rounded-lg p-2">p = <span class="term-knowledge">0.8</span><sup><span class="term-knowledge-weight">0.2</span></sup> × <span class="term-context">0.9</span><sup><span class="term-context-weight">0.6</span></sup> × <span class="term-tools">0.9</span><sup><span class="term-tools-weight">0.2</span></sup> ≈ 0.88 ou 88%</p>
