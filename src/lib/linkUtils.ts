...
export function createCommonLinks(locale: string) {
  return {
     ...
     */
    qavi: (text: string = "Qavi") => createInlineLink("https://quartoavista.com.br", text, true),
     ...
     */
    ufrn: (text: string = "UFRN") => createInlineLink("https://www.ufrn.br/", text, true),

    /**
     * Creates a link to UIUC
     */
    uiuc: (text: string = "UIUC") => createInlineLink("https://illinois.edu/", text, true),
     ...
     */
    experience: (text: string) => createInlineLink(`/${locale}/experience`, text),
